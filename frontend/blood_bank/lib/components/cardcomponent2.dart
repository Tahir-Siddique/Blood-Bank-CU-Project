...
class CardsDonor extends StatefulWidget {

  @override
  _CardsDonorState createState() => _CardsDonorState();
}

class _CardsDonorState extends State<CardsDonor> {
  @override
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.article,color: red,),
                      Center(child: Text("Request for Blood Donation", style:GoogleFonts.roboto(fontSize: 14,color: red,fontWeight: FontWeight.bold))),
                    ],
                  ),
                ),
